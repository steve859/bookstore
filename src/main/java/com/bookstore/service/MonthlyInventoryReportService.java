...
public class MonthlyInventoryReportService {
    ...
    public MonthlyInventoryReportResponse updateMonthlyInventoryReport(MonthlyInventoryReportDetails monthlyInventoryReportDetail, int amount, String type) {
        MonthlyInventoryReports monthlyInventoryReport = monthlyInventoryReportRepository.findByBookIdAndReportMonth(monthlyInventoryReportDetail.getBookId(),monthlyInventoryReportDetail.getReportDate().withDayOfMonth(1))
        ...
        monthlyInventoryReport.setClosingStock(monthlyInventoryReport.getOpeningStock()+monthlyInventoryReport.getStockIncrease()-monthlyInventoryReport.getStockDecrease());
        return monthlyInventoryReportMapper.toMonthlyInventoryReportResponse(monthlyInventoryReportRepository.save(monthlyInventoryReport));
    }
}
